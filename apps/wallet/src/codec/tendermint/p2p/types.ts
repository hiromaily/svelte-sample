...
export const ProtocolVersion = {
	...
	encode(message: ProtocolVersion, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.p2p !== undefined && !message.p2p.isZero()) {
			writer.uint32(8).uint64(message.p2p);
		}
		if (message.block !== undefined && !message.block.isZero()) {
			writer.uint32(16).uint64(message.block);
		}
		if (message.app !== undefined && !message.app.isZero()) {
	...
	fromPartial<I extends Exact<DeepPartial<ProtocolVersion>, I>>(object: I): ProtocolVersion {
		const message = createBaseProtocolVersion();
		message.p2p =
			object.p2p !== undefined && object.p2p !== null ? Long.fromValue(object.p2p) : Long.UZERO;
		message.block =
...
export const DefaultNodeInfo = {
	...
	encode(message: DefaultNodeInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.defaultNodeId !== undefined && message.defaultNodeId !== '') {
			writer.uint32(18).string(message.defaultNodeId);
		}
		if (message.listenAddr !== undefined && message.listenAddr !== '') {
		...
		if (message.moniker !== undefined && message.moniker !== '') {
...
export const DefaultNodeInfoOther = {
	...
	encode(message: DefaultNodeInfoOther, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.txIndex !== undefined && message.txIndex !== '') {
			writer.uint32(10).string(message.txIndex);
		}
		if (message.rpcAddress !== undefined && message.rpcAddress !== '') {
