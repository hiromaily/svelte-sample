...
export const Proof = {
	...
	encode(message: Proof, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.total !== undefined && !message.total.isZero()) {
			writer.uint32(8).int64(message.total);
		}
		if (message.index !== undefined && !message.index.isZero()) {
			writer.uint32(16).int64(message.index);
		}
		if (message.leafHash !== undefined && message.leafHash.length !== 0) {
			writer.uint32(26).bytes(message.leafHash);
		}
		if (message.aunts !== undefined && message.aunts.length !== 0) {
...
export const DominoOp = {
	...
	encode(message: DominoOp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.output !== undefined && message.output !== '') {
...
export const ProofOps = {
	...
	encode(message: ProofOps, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.ops !== undefined && message.ops.length !== 0) {
