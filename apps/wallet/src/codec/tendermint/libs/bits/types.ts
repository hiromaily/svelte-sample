...
function createBaseBitArray(): BitArray {
	return { $type: 'tendermint.libs.bits.BitArray', bits: Long.ZERO, elems: [] };
}
...
export const BitArray = {
	...
	encode(message: BitArray, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.bits !== undefined && !message.bits.isZero()) {
			writer.uint32(8).int64(message.bits);
		}
		if (message.elems !== undefined && message.elems.length !== 0) {
...
messageTypeRegistry.set(BitArray.$type, BitArray);
