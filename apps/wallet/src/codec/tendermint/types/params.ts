...
export const BlockParams = {
	...
	encode(message: BlockParams, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.timeIotaMs !== undefined && !message.timeIotaMs.isZero()) {
...
export const EvidenceParams = {
	...
	encode(message: EvidenceParams, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.maxAgeNumBlocks !== undefined && !message.maxAgeNumBlocks.isZero()) {
...
export const ValidatorParams = {
	...
	encode(message: ValidatorParams, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.pubKeyTypes !== undefined && message.pubKeyTypes.length !== 0) {
...
export const HashedParams = {
	...
	encode(message: HashedParams, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.blockMaxBytes !== undefined && !message.blockMaxBytes.isZero()) {
			writer.uint32(8).int64(message.blockMaxBytes);
		}
		if (message.blockMaxGas !== undefined && !message.blockMaxGas.isZero()) {
