...
export const Header = {
	...
	encode(message: Header, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.lastCommitHash !== undefined && message.lastCommitHash.length !== 0) {
			writer.uint32(50).bytes(message.lastCommitHash);
		}
		if (message.dataHash !== undefined && message.dataHash.length !== 0) {
			writer.uint32(58).bytes(message.dataHash);
		}
		if (message.validatorsHash !== undefined && message.validatorsHash.length !== 0) {
			writer.uint32(66).bytes(message.validatorsHash);
		}
		if (message.nextValidatorsHash !== undefined && message.nextValidatorsHash.length !== 0) {
			writer.uint32(74).bytes(message.nextValidatorsHash);
		}
		if (message.consensusHash !== undefined && message.consensusHash.length !== 0) {
			writer.uint32(82).bytes(message.consensusHash);
		}
		if (message.appHash !== undefined && message.appHash.length !== 0) {
			writer.uint32(90).bytes(message.appHash);
		}
		if (message.lastResultsHash !== undefined && message.lastResultsHash.length !== 0) {
			writer.uint32(98).bytes(message.lastResultsHash);
		}
		if (message.evidenceHash !== undefined && message.evidenceHash.length !== 0) {
			writer.uint32(106).bytes(message.evidenceHash);
		}
		if (message.proposerAddress !== undefined && message.proposerAddress.length !== 0) {
...
export const Vote = {
	...
	encode(message: Vote, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.validatorAddress !== undefined && message.validatorAddress.length !== 0) {
...
export const CommitSig = {
	...
	encode(message: CommitSig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.blockIdFlag !== undefined && message.blockIdFlag !== 0) {
...
export const Proposal = {
	...
	encode(message: Proposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.polRound !== undefined && message.polRound !== 0) {
...
export const BlockMeta = {
	...
	encode(message: BlockMeta, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.blockSize !== undefined && !message.blockSize.isZero()) {
			writer.uint32(16).int64(message.blockSize);
		}
		if (message.header !== undefined) {
			Header.encode(message.header, writer.uint32(26).fork()).ldelim();
		}
		if (message.numTxs !== undefined && !message.numTxs.isZero()) {
...
export const TxProof = {
	...
	encode(message: TxProof, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.rootHash !== undefined && message.rootHash.length !== 0) {
