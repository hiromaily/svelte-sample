...
export const Header = {
  ...
  encode(
    ...
    if (
      ...
      message.lastCommitHash.length !== 0
    ) {
    ...
    if (
      ...
      message.validatorsHash.length !== 0
    ) {
      writer.uint32(66).bytes(message.validatorsHash);
    }
    if (
      message.nextValidatorsHash !== undefined &&
      message.nextValidatorsHash.length !== 0
    ) {
      writer.uint32(74).bytes(message.nextValidatorsHash);
    }
    if (
      message.consensusHash !== undefined &&
      message.consensusHash.length !== 0
    ) {
    ...
    if (
      ...
      message.lastResultsHash.length !== 0
    ) {
      writer.uint32(98).bytes(message.lastResultsHash);
    }
    if (
      message.evidenceHash !== undefined &&
      message.evidenceHash.length !== 0
    ) {
      writer.uint32(106).bytes(message.evidenceHash);
    }
    if (
      message.proposerAddress !== undefined &&
      message.proposerAddress.length !== 0
    ) {
...
export const Vote = {
  ...
  encode(message: Vote, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (
      ...
      message.validatorAddress.length !== 0
    ) {
