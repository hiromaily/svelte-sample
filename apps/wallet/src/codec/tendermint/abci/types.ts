...
export const RequestInitChain = {
  ...
  encode(
    ...
    if (
      ...
      message.appStateBytes.length !== 0
    ) {
      writer.uint32(42).bytes(message.appStateBytes);
    }
    if (
      message.initialHeight !== undefined &&
      !message.initialHeight.isZero()
    ) {
...
export const RequestBeginBlock = {
  ...
  encode(
    ...
    if (
      message.byzantineValidators !== undefined &&
      message.byzantineValidators.length !== 0
    ) {
...
export const ResponseInfo = {
  ...
  encode(
    ...
    if (
      ...
      !message.lastBlockHeight.isZero()
    ) {
      writer.uint32(32).int64(message.lastBlockHeight);
    }
    if (
      message.lastBlockAppHash !== undefined &&
      message.lastBlockAppHash.length !== 0
    ) {
...
export const ResponseEndBlock = {
  ...
  encode(
    ...
    if (
      message.validatorUpdates !== undefined &&
      message.validatorUpdates.length !== 0
    ) {
...
export const ResponseApplySnapshotChunk = {
  ...
  encode(
    ...
    if (
      message.refetchChunks !== undefined &&
      message.refetchChunks.length !== 0
    ) {
      writer.uint32(18).fork();
    ...
    if (
      message.rejectSenders !== undefined &&
      message.rejectSenders.length !== 0
    ) {
...
export const Evidence = {
  ...
  encode(
    ...
    if (
      ...
      !message.totalVotingPower.isZero()
    ) {
