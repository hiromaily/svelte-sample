...
export const TxRaw = {
	...
	encode(message: TxRaw, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.bodyBytes !== undefined && message.bodyBytes.length !== 0) {
			writer.uint32(10).bytes(message.bodyBytes);
		}
		if (message.authInfoBytes !== undefined && message.authInfoBytes.length !== 0) {
...
export const SignDoc = {
	...
	encode(message: SignDoc, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.accountNumber !== undefined && !message.accountNumber.isZero()) {
...
export const TxBody = {
	...
	encode(message: TxBody, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.timeoutHeight !== undefined && !message.timeoutHeight.isZero()) {
			writer.uint32(24).uint64(message.timeoutHeight);
		}
		if (message.extensionOptions !== undefined && message.extensionOptions.length !== 0) {
			for (const v of message.extensionOptions) {
				Any.encode(v!, writer.uint32(8186).fork()).ldelim();
			}
		}
		if (
			message.nonCriticalExtensionOptions !== undefined &&
			message.nonCriticalExtensionOptions.length !== 0
		) {
...
export const AuthInfo = {
	...
	encode(message: AuthInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.signerInfos !== undefined && message.signerInfos.length !== 0) {
	...
	fromPartial<I extends Exact<DeepPartial<AuthInfo>, I>>(object: I): AuthInfo {
		...
		message.fee =
			object.fee !== undefined && object.fee !== null ? Fee.fromPartial(object.fee) : undefined;
		return message;
	}
};
...
export const SignerInfo = {
	...
	encode(message: SignerInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.sequence !== undefined && !message.sequence.isZero()) {
...
export const ModeInfo_Multi = {
	...
	encode(message: ModeInfo_Multi, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.modeInfos !== undefined && message.modeInfos.length !== 0) {
...
export const Fee = {
	...
	encode(message: Fee, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.amount !== undefined && message.amount.length !== 0) {
			for (const v of message.amount) {
				Coin.encode(v!, writer.uint32(10).fork()).ldelim();
			}
		}
		if (message.gasLimit !== undefined && !message.gasLimit.isZero()) {
			writer.uint32(16).uint64(message.gasLimit);
		}
		if (message.payer !== undefined && message.payer !== '') {
			writer.uint32(26).string(message.payer);
		}
		if (message.granter !== undefined && message.granter !== '') {
