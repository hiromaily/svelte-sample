...
export const ClientConsensusStates = {
	...
	encode(message: ClientConsensusStates, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.consensusStates !== undefined && message.consensusStates.length !== 0) {
...
export const ClientUpdateProposal = {
	...
	encode(message: ClientUpdateProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		...
		if (message.subjectClientId !== undefined && message.subjectClientId !== '') {
			writer.uint32(26).string(message.subjectClientId);
		}
		if (message.substituteClientId !== undefined && message.substituteClientId !== '') {
...
export const Height = {
	...
	encode(message: Height, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.revisionNumber !== undefined && !message.revisionNumber.isZero()) {
			writer.uint32(8).uint64(message.revisionNumber);
		}
		if (message.revisionHeight !== undefined && !message.revisionHeight.isZero()) {
...
export const Params = {
	...
	encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
		if (message.allowedClients !== undefined && message.allowedClients.length !== 0) {
