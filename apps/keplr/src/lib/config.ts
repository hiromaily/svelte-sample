...
export const AliceMnemonic = 'opera gasp shuffle gym submit glare swift dumb farm forum remember caught original empower melt wise curtain muscle spell defy kind mandate rescue vacant';
export const BobMnemonic = 'paddle goose fantasy photo project ask certain remove buddy valid explain pattern door best coach cinnamon front coach clump elephant voyage approve harsh market';
