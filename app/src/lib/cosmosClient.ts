...
export const createStargateClient = async (address: string, offlineSigner: any): Promise<SigningStargateClient> => {
...
export const createCosmWasmClient = (address: string, offlineSigner: any, chainId: string): SigningCosmWasmClient => {  
