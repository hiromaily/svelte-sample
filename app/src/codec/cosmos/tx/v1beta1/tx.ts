...
export const TxRaw = {
  ...
  encode(message: TxRaw, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (
      ...
      message.authInfoBytes.length !== 0
    ) {
...
export const TxBody = {
  ...
  encode(
    ...
    if (
      ...
      !message.timeoutHeight.isZero()
    ) {
      writer.uint32(24).uint64(message.timeoutHeight);
    }
    if (
      message.extensionOptions !== undefined &&
      message.extensionOptions.length !== 0
    ) {
