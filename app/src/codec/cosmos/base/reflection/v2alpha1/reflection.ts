...
export const TxDescriptor = {
  ...
  encode(
    ...
    if (message.msgs !== undefined && message.msgs.length !== 0) {
...
export const AuthnDescriptor = {
  ...
  encode(
    ...
    if (message.signModes !== undefined && message.signModes.length !== 0) {
...
export const CodecDescriptor = {
  ...
  encode(
    ...
    if (message.interfaces !== undefined && message.interfaces.length !== 0) {
...
export const InterfaceDescriptor = {
  ...
  encode(
    ...
    if (
      message.interfaceAcceptingMessages !== undefined &&
      message.interfaceAcceptingMessages.length !== 0
    ) {
    ...
    if (
      message.interfaceImplementers !== undefined &&
      message.interfaceImplementers.length !== 0
    ) {
...
export const InterfaceAcceptingMessageDescriptor = {
  ...
  encode(
    ...
    if (
      message.fieldDescriptorNames !== undefined &&
      message.fieldDescriptorNames.length !== 0
    ) {
...
export const MsgDescriptor = {
  ...
  encode(
    ...
    if (message.msgTypeUrl !== undefined && message.msgTypeUrl !== "") {
...
export const QueryServicesDescriptor = {
  ...
  encode(
    ...
    if (
      message.queryServices !== undefined &&
      message.queryServices.length !== 0
    ) {
...
export const QueryMethodDescriptor = {
  ...
  encode(
    ...
    if (message.fullQueryPath !== undefined && message.fullQueryPath !== "") {
