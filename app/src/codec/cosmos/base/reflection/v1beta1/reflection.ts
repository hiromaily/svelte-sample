...
export const ListAllInterfacesResponse = {
  ...
  encode(
    ...
    if (
      message.interfaceNames !== undefined &&
      message.interfaceNames.length !== 0
    ) {
...
export const ListImplementationsResponse = {
  ...
  encode(
    ...
    if (
      message.implementationMessageNames !== undefined &&
      message.implementationMessageNames.length !== 0
    ) {
