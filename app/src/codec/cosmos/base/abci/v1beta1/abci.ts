...
export const TxResponse = {
  ...
  encode(
    ...
    if (message.rawLog !== undefined && message.rawLog !== "") {
...
export const ABCIMessageLog = {
  ...
  encode(
    ...
    if (message.msgIndex !== undefined && message.msgIndex !== 0) {
...
function createBaseTxMsgData(): TxMsgData {
  return { $type: "cosmos.base.abci.v1beta1.TxMsgData", data: [] };
}
...
export const SearchTxsResult = {
  ...
  encode(
    ...
    if (message.totalCount !== undefined && !message.totalCount.isZero()) {
      writer.uint32(8).uint64(message.totalCount);
    }
    if (message.count !== undefined && !message.count.isZero()) {
      writer.uint32(16).uint64(message.count);
    }
    if (message.pageNumber !== undefined && !message.pageNumber.isZero()) {
      writer.uint32(24).uint64(message.pageNumber);
    }
    if (message.pageTotal !== undefined && !message.pageTotal.isZero()) {
      writer.uint32(32).uint64(message.pageTotal);
    }
    if (message.limit !== undefined && !message.limit.isZero()) {
