...
export interface SnapshotItem {
  $type: "cosmos.base.store.v1beta1.SnapshotItem";
...
export interface SnapshotStoreItem {
  $type: "cosmos.base.store.v1beta1.SnapshotStoreItem";
  name?: string;
}

/** SnapshotIAVLItem is an exported IAVL node. */
export interface SnapshotIAVLItem {
  $type: "cosmos.base.store.v1beta1.SnapshotIAVLItem";
  key?: Uint8Array;
  value?: Uint8Array;
  version?: Long;
  height?: number;
...
export const SnapshotItem = {
  $type: "cosmos.base.store.v1beta1.SnapshotItem" as const,
...
function createBaseSnapshotStoreItem(): SnapshotStoreItem {
  return { $type: "cosmos.base.store.v1beta1.SnapshotStoreItem", name: "" };
}

export const SnapshotStoreItem = {
  $type: "cosmos.base.store.v1beta1.SnapshotStoreItem" as const,
...
export const SnapshotIAVLItem = {
  $type: "cosmos.base.store.v1beta1.SnapshotIAVLItem" as const,
  ...
  encode(
    ...
    if (message.version !== undefined && !message.version.isZero()) {
