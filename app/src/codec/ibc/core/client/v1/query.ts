...
messageTypeRegistry.set(QueryClientStateResponse.$type, QueryClientStateResponse);
...
messageTypeRegistry.set(QueryClientStatesRequest.$type, QueryClientStatesRequest);
...
messageTypeRegistry.set(QueryClientStatesResponse.$type, QueryClientStatesResponse);
...
messageTypeRegistry.set(QueryConsensusStateRequest.$type, QueryConsensusStateRequest);
...
messageTypeRegistry.set(QueryConsensusStateResponse.$type, QueryConsensusStateResponse);
...
messageTypeRegistry.set(QueryConsensusStatesRequest.$type, QueryConsensusStatesRequest);
...
messageTypeRegistry.set(QueryConsensusStatesResponse.$type, QueryConsensusStatesResponse);
...
messageTypeRegistry.set(QueryClientStatusRequest.$type, QueryClientStatusRequest);
...
messageTypeRegistry.set(QueryClientStatusResponse.$type, QueryClientStatusResponse);
...
messageTypeRegistry.set(QueryClientParamsRequest.$type, QueryClientParamsRequest);
...
messageTypeRegistry.set(QueryClientParamsResponse.$type, QueryClientParamsResponse);
...
messageTypeRegistry.set(QueryUpgradedClientStateRequest.$type, QueryUpgradedClientStateRequest);
...
messageTypeRegistry.set(QueryUpgradedClientStateResponse.$type, QueryUpgradedClientStateResponse);
