...
messageTypeRegistry.set(MsgUpgradeClientResponse.$type, MsgUpgradeClientResponse);
...
messageTypeRegistry.set(MsgSubmitMisbehaviourResponse.$type, MsgSubmitMisbehaviourResponse);
