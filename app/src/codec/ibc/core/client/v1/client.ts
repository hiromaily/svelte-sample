...
export const ClientConsensusStates = {
  ...
  encode(
    ...
    if (
      message.consensusStates !== undefined &&
      message.consensusStates.length !== 0
    ) {
...
export const Height = {
  ...
  encode(
    ...
    if (
      ...
      !message.revisionNumber.isZero()
    ) {
      writer.uint32(8).uint64(message.revisionNumber);
    }
    if (
      message.revisionHeight !== undefined &&
      !message.revisionHeight.isZero()
    ) {
...
export const Params = {
  ...
  encode(
    ...
    if (
      message.allowedClients !== undefined &&
      message.allowedClients.length !== 0
    ) {
