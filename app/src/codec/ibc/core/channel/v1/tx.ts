...
messageTypeRegistry.set(MsgChannelOpenInitResponse.$type, MsgChannelOpenInitResponse);
...
messageTypeRegistry.set(MsgChannelOpenTryResponse.$type, MsgChannelOpenTryResponse);
...
messageTypeRegistry.set(MsgChannelOpenAckResponse.$type, MsgChannelOpenAckResponse);
...
messageTypeRegistry.set(MsgChannelOpenConfirmResponse.$type, MsgChannelOpenConfirmResponse);
...
messageTypeRegistry.set(MsgChannelCloseInitResponse.$type, MsgChannelCloseInitResponse);
...
messageTypeRegistry.set(MsgChannelCloseConfirmResponse.$type, MsgChannelCloseConfirmResponse);
...
messageTypeRegistry.set(MsgTimeoutOnCloseResponse.$type, MsgTimeoutOnCloseResponse);
...
messageTypeRegistry.set(MsgAcknowledgementResponse.$type, MsgAcknowledgementResponse);
