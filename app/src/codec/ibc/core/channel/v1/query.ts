...
messageTypeRegistry.set(QueryConnectionChannelsRequest.$type, QueryConnectionChannelsRequest);
...
messageTypeRegistry.set(QueryConnectionChannelsResponse.$type, QueryConnectionChannelsResponse);
...
messageTypeRegistry.set(QueryChannelClientStateRequest.$type, QueryChannelClientStateRequest);
...
messageTypeRegistry.set(QueryChannelClientStateResponse.$type, QueryChannelClientStateResponse);
...
messageTypeRegistry.set(QueryChannelConsensusStateRequest.$type, QueryChannelConsensusStateRequest);
...
messageTypeRegistry.set(QueryPacketCommitmentRequest.$type, QueryPacketCommitmentRequest);
...
messageTypeRegistry.set(QueryPacketCommitmentResponse.$type, QueryPacketCommitmentResponse);
...
messageTypeRegistry.set(QueryPacketCommitmentsRequest.$type, QueryPacketCommitmentsRequest);
...
messageTypeRegistry.set(QueryPacketCommitmentsResponse.$type, QueryPacketCommitmentsResponse);
...
messageTypeRegistry.set(QueryPacketReceiptRequest.$type, QueryPacketReceiptRequest);
...
messageTypeRegistry.set(QueryPacketReceiptResponse.$type, QueryPacketReceiptResponse);
...
messageTypeRegistry.set(QueryPacketAcknowledgementRequest.$type, QueryPacketAcknowledgementRequest);
...
messageTypeRegistry.set(QueryUnreceivedPacketsRequest.$type, QueryUnreceivedPacketsRequest);
...
messageTypeRegistry.set(QueryUnreceivedPacketsResponse.$type, QueryUnreceivedPacketsResponse);
...
messageTypeRegistry.set(QueryUnreceivedAcksRequest.$type, QueryUnreceivedAcksRequest);
...
messageTypeRegistry.set(QueryUnreceivedAcksResponse.$type, QueryUnreceivedAcksResponse);
...
messageTypeRegistry.set(QueryNextSequenceReceiveRequest.$type, QueryNextSequenceReceiveRequest);
...
messageTypeRegistry.set(QueryNextSequenceReceiveResponse.$type, QueryNextSequenceReceiveResponse);
