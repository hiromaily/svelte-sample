...
messageTypeRegistry.set(QueryConnectionsResponse.$type, QueryConnectionsResponse);
...
messageTypeRegistry.set(QueryClientConnectionsRequest.$type, QueryClientConnectionsRequest);
...
messageTypeRegistry.set(QueryClientConnectionsResponse.$type, QueryClientConnectionsResponse);
...
messageTypeRegistry.set(QueryConnectionClientStateRequest.$type, QueryConnectionClientStateRequest);
