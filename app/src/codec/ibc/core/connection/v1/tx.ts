...
messageTypeRegistry.set(MsgConnectionOpenInitResponse.$type, MsgConnectionOpenInitResponse);
...
messageTypeRegistry.set(MsgConnectionOpenTryResponse.$type, MsgConnectionOpenTryResponse);
...
messageTypeRegistry.set(MsgConnectionOpenAckResponse.$type, MsgConnectionOpenAckResponse);
...
messageTypeRegistry.set(MsgConnectionOpenConfirm.$type, MsgConnectionOpenConfirm);
...
messageTypeRegistry.set(MsgConnectionOpenConfirmResponse.$type, MsgConnectionOpenConfirmResponse);
